                ...
                <section class="text-gray-600 body-font">
                  <div class="container mx-auto">
                    ...
                    <div class="flex justify-end mb-4">
                      <button onclick="location.href='{{ route('admin.owners.create') }}'" class="bg-yellow-200 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-400 rounded text-lg">新規登録する</button>
                    </div>
